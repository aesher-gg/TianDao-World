# DATABASE FACTION REGIONAL — TIANDAO-WORLD

## Status
Canon Admin. Registry ini menampung faction regional yang sudah disebut oleh modul wilayah tetapi tidak cocok dipaksa masuk ke kategori sekte, dojo, imperial, criminal, atau organisasi umum.
...
- Detail yang belum ditetapkan menggunakan status `NOT-ESTABLISHED`.
...
## Batas Data
Registry ini sengaja tidak mengarang pemimpin, struktur internal, teknik, realm, aset, anggota, rank, stat modifier, atau NPC bernama. Detail tersebut harus datang dari Canon/Admin resmi.
