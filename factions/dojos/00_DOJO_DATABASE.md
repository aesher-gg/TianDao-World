...
- Relasi: kooperatif dengan keamanan Dinasti; kompetitif sehat dengan Sekte Pedang Canglan.

## 2. Dojo Bunga Aprikot
- ID: DOJ-002
...
- Relasi: dapat bekerja sama dengan institusi imperial, tetapi bukan bagian otomatis dari pemerintahan.
- Catatan: nama dan ajaran dojo merupakan Canon; teknik spesifik tetap mengikuti database teknik resmi.
...
- Relasi: terbuka untuk kerja sama lokal melalui latihan, kontrak, atau kebutuhan keamanan; tidak memiliki aliansi faction permanen yang dikunci.
...
- Agenda: menjaga murid tetap mampu bertahan di lingkungan ekstrem.
...
- Relasi: berhubungan operasional dengan jaringan perdagangan dan transportasi gurun sesuai kebutuhan perjalanan.
...
- Relasi: dapat berhubungan dengan jaringan perdagangan dan pengawalan laut sesuai kontrak; tidak otomatis berafiliasi dengan faction tertentu.
...
- Dojo tidak otomatis memberikan kultivasi tingkat tinggi.
- GM boleh membuat instruktur minor dan sesi latihan lokal melalui Module 26, tetapi tidak boleh membuat teknik tingkat tinggi tanpa sumber yang valid.
- Detail organisasi yang belum memiliki Canon tetap diperlakukan sebagai data non-fixed; GM tidak boleh mengubahnya menjadi fakta historis hanya berdasarkan nama, genre, atau asumsi.
- Admin dapat menetapkan detail baru melalui perubahan Canon resmi; perubahan tersebut menjadi sumber valid setelah tersimpan di repository.
