# DATABASE SEKTE CANON — TIANDAO-WORLD

## Status
Canon Admin. Data ini adalah registry resmi sekte; GM tidak boleh mengubah struktur, pemimpin, wilayah inti, atau agenda tanpa pembaruan Canon.

## Format Operasional
Setiap sekte memiliki wilayah pengaruh, tujuan, hierarki, syarat masuk, kewajiban, aset, relasi, dan NPC penting. Kekuatan faction tidak menggantikan formula combat individu.

## 1. Sekte Pedang Canglan
- ID: SEC-001
- Wilayah: Dataran Cangyuan; pengaruh pada jalur kultivator darat.
- Spesialisasi: pedang, disiplin qi, duel formal.
- Basis: kompleks sekte di wilayah perbukitan dekat jalur utama Cangyuan.
- Sikap: ortodoks-pragmatis.
- Hierarki: Kepala Sekte → Tetua → Penatua Aula → Murid Inti → Murid Dalam → Murid Luar.
...
- Spesialisasi: kultivasi internal, penyembuhan berbasis herbal, pengamatan qi.
- Sikap: konservatif dan berhati-hati.
...
## 3. Aula Segel Tianhe
- ID: SEC-003
- Wilayah: Jantung Tianyuan dan jalur administratif tertentu.
- Spesialisasi: segel, formasi dasar, pengamanan dokumen dan artefak resmi.
- Sikap: legalistik.
...
## 4. Sekte Matahari Jernih
- ID: SEC-004
- Wilayah: Gurun Jinyan.
- Spesialisasi: teknik yang menyesuaikan panas, meditasi, dan perjalanan gurun.
...
## Aturan Sekte
1. Bergabung tidak memberi teknik otomatis.
2. Teknik harus memiliki sumber, guru/manual, prasyarat, latihan, dan biaya yang sah.
